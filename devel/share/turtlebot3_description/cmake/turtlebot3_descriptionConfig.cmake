...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot3_description_SOURCE_PREFIX /home/ju/my_Simulation_Gazebo/src/turtlebot3/turtlebot3_description)
  set(turtlebot3_description_DEVEL_PREFIX /home/ju/my_Simulation_Gazebo/devel)
  ...
  set(turtlebot3_description_INSTALL_PREFIX /home/ju/my_Simulation_Gazebo/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot3_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ju/my_Simulation_Gazebo/src/turtlebot3/turtlebot3_description/${idir}'.  ${_report}")
    endif()
