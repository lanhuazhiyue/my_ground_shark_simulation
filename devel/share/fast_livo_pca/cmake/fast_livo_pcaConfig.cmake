...
if(fast_livo_pca_CONFIG_INCLUDED)
  return()
endif()
set(fast_livo_pca_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(fast_livo_pca_SOURCE_PREFIX /home/ju/my_ground_shark_simulation/src/FAST-LIVO2-PCA)
  set(fast_livo_pca_DEVEL_PREFIX /home/ju/my_ground_shark_simulation/devel)
  set(fast_livo_pca_INSTALL_PREFIX "")
  set(fast_livo_pca_PREFIX ${fast_livo_pca_DEVEL_PREFIX})
else()
  set(fast_livo_pca_SOURCE_PREFIX "")
  set(fast_livo_pca_DEVEL_PREFIX "")
  set(fast_livo_pca_INSTALL_PREFIX /home/ju/my_ground_shark_simulation/install)
  set(fast_livo_pca_PREFIX ${fast_livo_pca_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'fast_livo_pca' is deprecated")
...
set(fast_livo_pca_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/include/opencv4;/home/ju/Sophus " STREQUAL " ")
  set(fast_livo_pca_INCLUDE_DIRS "")
  set(_include_dirs "/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/include/opencv4;/home/ju/Sophus")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${fast_livo_pca_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'fast_livo_pca' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'fast_livo_pca' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ju/my_ground_shark_simulation/src/FAST-LIVO2-PCA/${idir}'.  ${_report}")
    endif()
    _list_append_unique(fast_livo_pca_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND fast_livo_pca_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND fast_livo_pca_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT fast_livo_pca_NUM_DUMMY_TARGETS)
      set(fast_livo_pca_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::fast_livo_pca::wrapped-linker-option${fast_livo_pca_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR fast_livo_pca_NUM_DUMMY_TARGETS "${fast_livo_pca_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::fast_livo_pca::wrapped-linker-option${fast_livo_pca_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND fast_livo_pca_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND fast_livo_pca_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(fast_livo_pca_LIBRARY_DIRS ${lib_path})
      list(APPEND fast_livo_pca_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'fast_livo_pca'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND fast_livo_pca_LIBRARIES ${lib})
    endif()
  endif()
...
set(fast_livo_pca_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${fast_livo_pca_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 fast_livo_pca_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${fast_livo_pca_dep}_FOUND)
      find_package(${fast_livo_pca_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${fast_livo_pca_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(fast_livo_pca_INCLUDE_DIRS ${${fast_livo_pca_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(fast_livo_pca_LIBRARIES ${fast_livo_pca_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${fast_livo_pca_dep}_LIBRARIES})
  _list_append_deduplicate(fast_livo_pca_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(fast_livo_pca_LIBRARIES ${fast_livo_pca_LIBRARIES})

  _list_append_unique(fast_livo_pca_LIBRARY_DIRS ${${fast_livo_pca_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(fast_livo_pca_EXPORTED_TARGETS ${${fast_livo_pca_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${fast_livo_pca_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
