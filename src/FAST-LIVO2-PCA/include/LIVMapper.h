...
public:
  ...
  // void publish_PlaneNormal(const ros::Publisher &plane_pub);
  ...
  std::unordered_map<VOXEL_LOCATION, VoxelTree *> voxel_map;
  ...
  StatesGroup _state;           // 后验状态
  StatesGroup  state_propagat;  // 先验状态
